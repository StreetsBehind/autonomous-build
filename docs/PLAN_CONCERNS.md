...
| `abuse-surface` | Rate-limiting, input validation/bounds, abuse vectors | For each public surface: input-validation + rate-limit stance **or** `excluded` ("no public/unauthenticated network surface"). |
